...
namespace IndentApplicationManagement.Bll.Base
{
	...
	{
		protected static IndentApplicationManagement.Dal.CompanyDal dal = new IndentApplicationManagement.Dal.CompanyDal();
		...
		public List<Company> GetAllCompany(int CompanyName)
		{
			Hashtable lstItems = new Hashtable();
			lstItems.Add("@CompanyName", CompanyName);
		...
		public Company GetCompanyByCompanyId(int _CompanyId,int _CompanyName)
		{
			Hashtable lstItems = new Hashtable();
			lstItems.Add("@CompanyId", _CompanyId);
			lstItems.Add("@CompanyName", _CompanyName);
