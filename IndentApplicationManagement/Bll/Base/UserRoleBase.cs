...
namespace IndentApplicationManagement.Bll.Base
{
	...
	{
		protected static IndentApplicationManagement.Dal.UserRoleDal dal = new IndentApplicationManagement.Dal.UserRoleDal();
		...
		public UserRole GetUserRoleByRoleId(int _RoleId,int _CompanyId)
		{
			Hashtable lstItems = new Hashtable();
