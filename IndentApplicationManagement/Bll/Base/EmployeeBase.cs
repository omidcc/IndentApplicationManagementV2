...
namespace IndentApplicationManagement.Bll.Base
{
	...
	{
		protected static IndentApplicationManagement.Dal.EmployeeDal dal = new IndentApplicationManagement.Dal.EmployeeDal();
		...
		protected  Employee GetObject(DataRow dr)
		{
			...
			objEmployee.DOB = (dr["DOB"] == DBNull.Value) ? "" : (String)dr["DOB"];
			objEmployee.JoinDate = (dr["JoinDate"] == DBNull.Value) ? "" : (String)dr["JoinDate"];
